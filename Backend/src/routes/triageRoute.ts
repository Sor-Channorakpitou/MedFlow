 ...
 */
router.get("/queue", authenticate, authorize(["DOCTOR", "NURSE"]), getQueue);
 ...
 *         description: Unauthorized
 */
router.post("/", authenticate, authorize(["DOCTOR", "NURSE"]), addTriage, emitWorkflowChange);
 ...
 */
router.get("/:appointmentId", authenticate, authorize(["DOCTOR", "NURSE"]), getTriageByAppointment);
 ...
 */
router.put("/:appointmentId", authenticate, authorize(["DOCTOR", "NURSE"]), updateTriage, emitWorkflowChange);
