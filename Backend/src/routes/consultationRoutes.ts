 ...
 *         description: Unauthorized
 */
router.post("/", authenticate, authorize(["DOCTOR"]), consultController.createConsultation, emitWorkflowChange);
 ...
 */
router.put("/:appointmentId", authenticate, authorize(["DOCTOR"]), consultController.updateExistingConsultation, emitWorkflowChange);
