...
export const insertAppointment = async (data) => {
    ...
    return toAppointmentDTO(await prisma.appointment.create({
        data: {
...
export const modifyAppointment = async (id, data) => {
    ...
    return toAppointmentDTO(await prisma.appointment.update({
        where: { id },
        data: updateData,
        include: {
            patient: true,
...
export const assignDoctor = async (appointmentId, userId) => {
    const appointment = await prisma.appointment.findUnique({
